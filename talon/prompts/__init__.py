...
def get_prompt_templates(task, agent_type):
    ...
    elif task == 'tabfact' and agent_type in ['PyReAct', 'ReadSchema', 'RandSampling', 'TableSampling','TableTools']:
        # return {'solve_table_prompt': tabfact.pyreact_solve_table_prompt}
        
        if agent_type=='TableTools':
            return {'solve_table_prompt': tabfact.pyreact_solve_table_prompt_tools}
        else:
            return {'solve_table_prompt': tabfact.pyreact_solve_table_prompt}
    ...
    elif task == 'wtq' and agent_type in ['PyReAct', 'ReadSchema', 'RandSampling', 'TableSampling','TableTools']:
        # return {'solve_table_prompt': wtq.pyreact_solve_table_prompt}
        if agent_type=='TableTools':
            return {'solve_table_prompt': wtq.pyreact_solve_table_prompt_tools}
        else:
            return {'solve_table_prompt': wtq.pyreact_solve_table_prompt}
    ...
    elif task in ['arcade', 'bird'] and agent_type in ['PyReAct', 'ReadSchema', 'RandSampling', 'TableSampling','TableTools']:
        if agent_type=='TableTools':
            return {'solve_table_prompt': arcade.pyreact_solve_table_prompt_tools}
        else:

...
Given a large table and several sampled rows, indicated that the table have more than 50 rows, you need to answer the question: "{query}".
...
- `get_row(row_index)`: Use this tool to retrieve a specific row from the table. Or you can use this tool to understand the relationship of two colums in a row. Be carful to use it until you exact know the index of the row, do not assume the index of the row. 
